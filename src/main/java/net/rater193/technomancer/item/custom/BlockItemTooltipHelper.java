...
public class BlockItemTooltipHelper extends BlockItem {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        if(Screen.hasShiftDown()) {
            ...
            components.add(Component.translatable("tooltip.block."+blockNameSubs[blockNameSubs.length-1]).withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.AQUA));
        }else{
